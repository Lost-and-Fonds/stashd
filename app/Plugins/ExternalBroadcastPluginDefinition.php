...
final readonly class ExternalBroadcastPluginDefinition
{
    ...
    public function __construct(
        ...
        public ?string $librarySettingKey,
    ...
    public static function fromManifest(mixed $raw, string $root, string $socketPath, ?string $manifestDirectory = null): ?self
    {
        ...
        return new self(
            ...
            librarySettingKey: is_string($raw['library_setting_key'] ?? null) && trim($raw['library_setting_key']) !== '' ? trim($raw['library_setting_key']) : null,
