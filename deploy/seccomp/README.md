...
- `mount` argument 3 with the eleven observed flag combinations for root slave,
  tmpfs, recursive bind, bind, read-only and writable bind remounts (including
  `MS_NOATIME`), devpts, and private root;
