...
require_once __DIR__ . '/../m6/PackageManager.php';
...
{
    $process = proc_open(['tar', '-czf', $archive, '-C', $source, 'plugin.json', 'plugin.php', 'sdk/Sdk.php', 'rpc/FrameCodec.php', 'helpers/fixture-helper.php'], [1 => ['pipe', 'w'], 2 => ['pipe', 'w']], $pipes);
...
final class M7HostProcess
{
    ...
    public function __construct(
        ...
        $command = [
            ...
            '--unshare-uts', '--unshare-net', '--clearenv', '--ro-bind', $packageRoot, '/plugin',
            '--bind', $this->invocationRoot(), '/staging', '--tmpfs', '/tmp', '--dev', '/dev',
            '--ro-bind', '/usr', '/usr', '--ro-bind', '/bin', '/bin', '--ro-bind', '/lib', '/lib',
            '--ro-bind', '/lib64', '/lib64', '--ro-bind', '/sbin', '/sbin', '--dir', '/etc', '--dir',
            '/home', '--dir', '/root', '--dir', '/run', '--chdir', '/plugin', '--setenv', 'HOME', '/tmp',
            '--setenv', 'PATH', '/usr/local/bin:/usr/bin:/bin', '--', 'php', '/plugin/plugin.php',
        ];
        $this->pipes = [];
    ...
    private function invocationRoot(): string { return $this->stagingRoot; }
}
...
try {
    ...
    copy(__DIR__ . '/fixture-plugin.php', $source . '/plugin.php');
    copy(__DIR__ . '/fixture-helper.php', $source . '/helpers/fixture-helper.php');
    copy(__DIR__ . '/../m4/sdk/Sdk.php', $source . '/sdk/Sdk.php');
    copy(__DIR__ . '/../rpc/FrameCodec.php', $source . '/rpc/FrameCodec.php');
    ...
    m7Remove($root);
    echo "M7 native conformance and operational smoke: PASS\n";
} catch (Throwable $exception) {
    m7Remove($root);
    throw $exception;
}
