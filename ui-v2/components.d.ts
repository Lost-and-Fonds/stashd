...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    PluginActions: typeof import('./src/components/plugin/PluginActions.vue')['default']
    PluginDetailFields: typeof import('./src/components/plugin/PluginDetailFields.vue')['default']
